...
class Music(discord.Cog):    
    ...
    async def play(self, ctx : discord.ApplicationContext, *, search: str):
        ...
        try:
            ...
            await ctx.respond(self.__config.value["exception_response"]["already_playing"])
        except NotConnectedToVoiceChannelException:
            await ctx.respond(self.__config.value["exception_response"]["not_connected_to_voice_channel"])
        except NoResultsFoundException:
            await ctx.respond(self.__config.value["exception_response"]["no_results_found"])
        except:
            Log(traceback.format_exc(), LogType.ERROR)
    ...
    async def stop(self, ctx : discord.ApplicationContext):
        ...
        try: 
            ...
            await ctx.respond(self.__config.value["response"]["music_stopping"])
        except NoPlayingInstanceException:
            await ctx.respond(self.__config.value["exception_response"]["not_playing_music"])
        except:
            Log(traceback.format_exc(), LogType.ERROR)
            await ctx.respond(self.__config.value["exception_response"]["default"])
    ...
    async def pause(self, ctx : discord.ApplicationContext):
        ...
        try:
            ...
            await ctx.respond(self.__config.value["response"]["pausing_music"].replace("{music}", str(self.__guild_music_manager.get(ctx.guild.id).now)))
        except NoPlayingInstanceException:
            await ctx.respond(self.__config.value["exception_response"]["not_playing_music"])
        except:
            Log(traceback.format_exc(), LogType.ERROR)
    ...
    async def resume(self, ctx : discord.ApplicationContext):
        ...
        try:
            ...
            await ctx.respond(self.__config.value["response"]["resuming_music"].replace("{music}", str(self.__guild_music_manager.get(ctx.guild.id).now)))
        except NoPlayingInstanceException:
            await ctx.respond(self.__config.value["exception_response"]["not_playing_music"])
        except:
            Log(traceback.format_exc(), LogType.ERROR)
    ...
    async def back(self, ctx : discord.ApplicationContext):
        ...
        try:
            ...
            await ctx.respond(self.__config.value["response"]["back_to_previous_music"])
        except NothingLeftInBackQueueException:
            await ctx.respond(self.__config.value["exception_response"]["nothing_left_in_previous_queue"])
        except NoPlayingInstanceException:
            await ctx.respond(self.__config.value["exception_response"]["not_playing_music"])
        except:
            Log(traceback.format_exc(), LogType.ERROR)
    ...
    async def skip(self, ctx : discord.ApplicationContext):
        ...
        try:
            ...
            await ctx.respond(self.__config.value["response"]["skipping_music"])
        except NothingLeftInQueueException:
            await ctx.respond(self.__config.value["exception_response"]["nothing_left_in_queue"])
        except NoPlayingInstanceException:
            await ctx.respond(self.__config.value["exception_response"]["not_playing_music"])
        except:
            Log(traceback.format_exc(), LogType.ERROR)
