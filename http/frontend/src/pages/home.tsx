    ...
    <>
      <header className="flex flex-col items-center justify-center min-h-screen text-white">
        <h1 className="text-6xl font-extrabold mb-6 drop-shadow-lg">
          {t("home.welcome_to")}{" "}
          <span className="text-yellow-300">{t("home.name")}</span>
        </h1>
        <p className="text-2xl mb-8 max-w-lg text-center drop-shadow-md">
          {t("home.description")}
        </p>
      </header>
      <div className="bg-black bg-opacity-70 p-8 my-8 rounded-lg max-w-4xl mx-auto">
        <h2 className="text-3xl font-semibold mb-4">
          {t("home.about_us.title")}
        </h2>
        <p className="mb-4">{t("home.about_us.paragraph1")}</p>
        <p>{t("home.about_us.paragraph2")}</p>
      </div>

      <section className="bg-yellow-300 text-black p-8 my-8 rounded-lg max-w-4xl mx-auto text-center">
        <h2 className="text-3xl font-semibold mb-4">
          {t("home.join_our_discord.title")}
        </h2>
        <p className="mb-4">{t("home.join_our_discord.description")}</p>
      ...
      <footer className="bg-black bg-opacity-70 text-center py-4">
        <p className="text-sm text-gray-300">
          {new Date().getFullYear()} &copy; {t("home.name")}.{" "}
